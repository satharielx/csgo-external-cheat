    ...
    public partial class Settings : Form
    {
       ...
       // public Items Instance { get; private set; }
        ...
        private void Settings_Load(object sender, EventArgs e)
        {
            ...
            UtilityGlow = new Thread(Program.LaunchUtilityGlow);
        ...
        public void Valid() {
            ...
            if (GlowEspOn && !gonce) { Glow.Start(); UtilityGlow.Start(); gonce = true; }
        ...
        private void OnOffCheck() {
            while (!TriggerOn) { if (tonce) Trigger.Join(); Thread.Sleep(100); }
            while (!GlowEspOn) { if (gonce) { Glow.Join(); } Thread.Sleep(100); }
            while (!BunnyOn) { if (bonce) Bunny.Join(); Thread.Sleep(100); }
        }
