...
namespace whelper
{
    ...
    public class DWriteText : IDisposable
    {
        ...
        public DWriteText()
        {
            ...
            devc = new SharpDX.Direct3D9.Device(new Direct3D(), 0, DeviceType.Hardware, form.Handle,
                CreateFlags.HardwareVertexProcessing,
                new PresentParameters(form.Width, form.Height) {PresentationInterval = PresentInterval.One});
        ...
        public void Draw(string toDraw, float x, float y)
        {
            if (x > DesktopSize.Width && y > DesktopSize.Height && x < DesktopSize.Width &&
                y < DesktopSize.Height) return;
            ...
            g.DrawString(toDraw, new System.Drawing.Font("Century Gothic", 9, FontStyle.Bold), s, Location);
            g.Dispose();
        ...
        public void Draw(string toDraw, float x, float y, float width, float height, Color boxColor)
        {
            if (x > DesktopSize.Width && y > DesktopSize.Height && x < DesktopSize.Width &&
                y < DesktopSize.Height) return;
            Location = new PointF(x, y);
            ...
            g.TextRenderingHint = System.Drawing.Text.TextRenderingHint.AntiAliasGridFit;
            g.DrawString(toDraw, new System.Drawing.Font("Century Gothic", 9, FontStyle.Bold), s, rect);
            g.Dispose();
            ReleaseDC(IntPtr.Zero, desk);
            running = true;
            drawn = true;
        ...
        public void Update(string newString)
        {
            ...
            while (running)
            {
                ...
                g.DrawString(newString, new System.Drawing.Font("Century Gothic", 10), s, Location);
                g.Dispose();
                ReleaseDC(IntPtr.Zero, desk);
            }
